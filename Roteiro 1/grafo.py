...
class Grafo:
    ...
    def ha_paralelas(self):
        ...
        for i in arestas:
            v1, v2 = i.split(self.SEPARADOR_ARESTA)
            if(arestas.count("{}-{}".format(v1,v2)) > 1):
                return True
    ...
    def  grau(self, vertice):
        ...
        cont = 0
        for i in aresta:
            if aresta[i][0] == vertice or aresta[i][2] == vertice:
                    cont += 1
    ...
    def eh_completo(self):
        ...
        for i in range(len(verticies)):
            for j in range(i+1 , len(verticies)):
                    lista_completo.append("{}-{}".format(verticies[i],verticies[j]))
        ...
        if len(lista_completo) != len(arestas):
            ...
            for i in range(len(lista_completo)):
                ...
                if (lista_completo[i] not in arestas):
                    if "{}-{}".format(v2,v1) not in arestas:
                        return False
                    continue
